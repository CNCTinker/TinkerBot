...
Build KLIPPER for SERIAL communication
-------------------------------------------
...
Now for KLIPPER connect ESP32 to your MCU running Klipper pins (the ones you select in klipper GPIO0/GPIO1) - depending on your MCU you can change them.  
Connect RX->TX,TX->RX and 5v, GND from the board/MCU to ESP32
